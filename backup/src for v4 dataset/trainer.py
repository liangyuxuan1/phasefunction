...
class Trainer:
    ...
    def run(self, train_dataloader, val_dataloader, network, loss_func, optimizer, scheduler, num_epochs, model_dir, model_name, device=None):
        ...
        for epoch in range(num_epochs):
            ...
            if val_loss < val_loss_min:
                self.logger.info('Validation loss decreased ({:.6f} --> {:.6f}).  Saving model ...'.format(val_loss_min, val_loss))
