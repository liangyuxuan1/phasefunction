...
if __name__=='__main__':
    ...
    checkpoint_path = 'training_results_PReLU'
    ...
    # val_results  = show_Results(val_data,  'validating_results_figures_PReLU', save_figure=False)
    fn_val = os.path.join('validating_results_figures_PReLU', 'val_results.npy')
    ...
    # ----- Test Results ---------------------------------------------------------------------------
    # test_results = show_Results(test_data, 'testing_results_figures_PReLU', save_figure=False)
    fn_test = os.path.join('testing_results_figures_PReLU', 'test_results.npy')
