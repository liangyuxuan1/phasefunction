...
<<<<<<< HEAD:Fig_Cross_Val_Results_v4Data/Fig_show_resnet18_crossval_results.py
...
>>>>>>> ff054791c8c10394bab14dc2f3d92c796f655bc6:Fig_Cross_Val_Results/Fig_show_resnet18_crossval_results.py
df = pd.DataFrame()
for file in files:
...
df.loc[df['Events']=='Train', 'n'] = 4800
df.loc[df['Events']=='Validation', 'n'] = 1200
...
figFile = os.path.join(os.path.dirname(__file__), 'Fig_AIC_BIC.png')
...
figFile = os.path.join(os.path.dirname(__file__), 'Fig_Cross_Val.png')
plt.savefig(figFile, bbox_inches='tight')
plt.show()
